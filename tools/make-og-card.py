...
This is the eakansascity.org copy; the becomingstronger original runs the same
script with its own defaults.
"""
...
DEFAULTS = dict(
    page="cause-prioritization.html",
    # mounts inside .cp because that is where the artifact's CSS variables live
    mount=".cp",
    out="og-card-evidence.png",
    eyebrow="Effective Altruism Kansas City",
